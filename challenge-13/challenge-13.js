(function () {
  ...
  */
  ...
  var myArray = [ 'Rodrigo', 41, 'Canoas', 88 ];
  ...
  */
  ...
  var sul = [ 'Rio Grande do Sul', 'Santa Catariana', 'Paraná' ];
  ...
  */
  ...
  var hasCity = brasil.some(function( item ) {
    return item === 'Ceará'
  });
  console.log( hasCity ? 'Ceará está incluído!' : 'Ceará não foi incluído :(' );
