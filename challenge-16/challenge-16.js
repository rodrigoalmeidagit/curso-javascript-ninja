(function () {
  ...
  */
  ...
  [LETRA] é a [INDEX] letra do meu nome.
  */
  ...
  */
  ...
  var fiveFriends = ['Paulo', 'Cristiano', 'Jaime', 'Roberta', 'Vanessa'];
  var concatFriends = fiveFriends.reduce(function( total, value, index ) {
    var separator = fiveFriends.length - 1 === index ? ' e ' : ', ';
    return total + separator + value;
